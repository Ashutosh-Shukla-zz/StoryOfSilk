					...
					<div class="row">
							...
							<form class="nomargin sky-form"
								...
								<fieldset class="nomargin">
									<label class="input margin-bottom-10"> <i
										class="ico-append fa fa-envelope"></i> 
										...
										class="ico-append fa fa-lock"></i> <input type="password" 
											name="password" placeholder="Password" /><b
										class="tooltip tooltip-bottom-right">Only latin characters
											and numbers</b>
									</label> <label class="input margin-bottom-10"> <i
										class="ico-append fa fa-lock"></i> <input type="password"
										placeholder="Confirm password"></input> <b
										class="tooltip tooltip-bottom-right">Only latin characters
											and numbers</b>
									</label>
									...
									<label class="select margin-bottom-10 margin-top-20"> <select
											name="gender">
									...
									<!-- <div class="margin-top-30">
										<label class="checkbox nomargin"><input
											class="checked-agree" type="checkbox" name="checkbox"><i></i>I
											agree to the <a href="#" data-toggle="modal"
											data-target="#termsModal">Terms of Service</a></label> <label
											class="checkbox nomargin"><input type="checkbox"
											name="checkbox"><i></i>I want to receive news and
						...
						<div class="col-md-6 col-sm-6">
							<form action="#" method="post" class="sky-form">
								...
								<header class="size-18 margin-bottom-20"> Register
									using your social network </header>
								...
								<footer>
									Already have an account? <a href="#" data-toggle="modal"
										...
										aria-hidden="true"><strong>Back to login!</strong></a>
								</footer>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body modal-short">
				...
				<p>[You must be at least [18] years of age to use this website.
					By using this website [and by agreeing to these terms and
				...
				<p>Unless otherwise stated, [NAME] and/or its licensors own the
				...
				<p>You must not conduct any systematic or automated data
					...
					this website without [NAME'S] express written consent.</p>
				...
				<p>[Access to certain areas of this website is restricted.]
					...
					discretion.</p>
				<p>If [NAME] provides you with a user ID and password to enable
				...
				<p>In these terms and conditions, "your user content" means
					...
					to this website, for whatever purpose.</p>
				<p>You grant to [NAME] a worldwide, irrevocable, non-exclusive,
					...
					You also grant to [NAME] the right to sub-license these rights, and
					the right to bring an action for infringement of these rights.</p>
				<p>Your user content must not be illegal or unlawful, must not
					...
					giving rise to legal action whether against you or [NAME] or a
				...
				<p>[NAME] reserves the right to edit or remove any material
					submitted to this website, or stored on [NAME'S] servers, or hosted
				...
				<p>[Notwithstanding [NAME'S] rights under these terms and
					...
					to monitor the submission of such content to, or the publication of
					such content on, this website.]</p>

				<h4>
					<strong>No warranties</strong>
				</h4>
				<p>This website is provided "as is" without any representations
					or warranties, express or implied. [NAME] makes no representations
				...
				<p>These limitations of liability apply even if [NAME] has been
				...
				<p>Nothing in this website disclaimer will exclude or limit any
					...
					[NAME'S] liability in respect of any:</p>
				<ul>
				...
				<p>[You accept that, as a limited liability entity, [NAME] has
					...
					against [NAME'S] officers or employees in respect of any losses you
				...
				<p>If any provision of this website disclaimer is, or is found
					to be, unenforceable under applicable law, that will not affect the
				...
				<p>You hereby indemnify [NAME] and undertake to keep [NAME]
					...
					amounts paid by [NAME] to a third party in settlement of a claim or
					dispute on the advice of [NAME'S] legal advisers) incurred or
				...
				<p>Without prejudice to [NAME'S] other rights under these terms
					and conditions, if you breach these terms and conditions in any
					way, [NAME] may take such action as [NAME] deems appropriate to
				...
				<p>[NAME] may transfer, sub-contract or otherwise deal with
					[NAME'S] rights and/or obligations under these terms and conditions
				...
				<p>These terms and conditions [, together with [DOCUMENTS],]
					constitute the entire agreement between you and [NAME] in relation
					to your use of this website, and supersede all previous agreements
					in respect of your use of this website.</p>

				<h4>
					<strong>Law and jurisdiction</strong>
				</h4>
				<p>These terms and conditions will be governed by and construed
					in accordance with [GOVERNING LAW], and any disputes relating to
					these terms and conditions will be subject to the [non-]exclusive
					jurisdiction of the courts of [JURISDICTION].</p>
				...
				<p>
					...
					and available at <a href="#">www.yourwebsite.com</a>. Contractology
					supply a wide variety of commercial legal documents, such as <a
				...
				<p>[[NAME] is registered with [TRADE REGISTER]. You can find the
				...
				<p>[[NAME] is registered with [PROFESSIONAL BODY]. [NAME'S]
					...
					[JURISDICTION]. [NAME] is subject to the [RULES] which can be found
					at [URL].]</p>
				...
				<p class="margin-top30">
					<strong>By using this WEBSITE TERMS AND CONDITIONS
						...
						requirements of your jurisdiction, your business and your website.
						If you are not a lawyer, we recommend that you take professional
						legal advice in relation to the editing and use of the template.
					</strong>
				</p>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="terms-agree">
